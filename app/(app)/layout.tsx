...
import AIDock from "@/components/shell/AIDock";
  ...
  return (
    <div className="flex h-screen w-full flex-col overflow-hidden bg-neutral-950 text-neutral-100">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Left Menu */}
        <aside className="hidden md:block w-16 shrink-0 border-r border-neutral-800">
          <LeftMenu />
        </aside>
        ...
        {/* Main Content */}
        <main className="flex-1 overflow-auto p-6 pb-28 md:pb-28">{children}</main>
      </div>
